            ...
            <div class="modal-content">
                <div class="modal-header border-bottom-0">
                    ...
                    <div class="head-title text-center">
                        <b class="-text-red font-22 head-font"> WELCOME </b><br/>
                        <span class="font-14">
                ...
                <div class="modal-body">
                    <form id="frmLogin" method="post" role="form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6 form-group text-left">
                                <a href="<?php echo home_url() ?>">Go Back</a>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-6 form-group text-right">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group center text-center">
                                <button type="submit" class="btn btn-danger width-100 btn-login btn-reg"> Login </button>
                                <input type="hidden" class="Reqtype" value=""/>
                                <input type="hidden" class="mlsNum" value=""/>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="post" role="form" id="frmForgetPwd">
                        ...
                        <div>
                            <a href="<?php echo $login_url ?>">Go Back</a>
                        </div>
                        <!--<div class="row">
							<div class="col-12 col-sm-12 col-md-12 col-lg-12 form-group">
